...
const BattleshipGame = () => {
  ...
  const llmTimerRef = useRef<IntervalRef>(null);
  const questionCountRef = useRef<IntervalRef>(null);


  useEffect(() => {
    // Store refs when the effect is created
  ...
  const handleTerrainGenerated = useCallback((newTerrain: TerrainGrid) => {
  ...
  // 1. Define a type for your stats
  type UncertaintyStats = {
    percentage: number;
    eliminated: number;
    total: number;
  };
  ...
  const renderUncertaintyBar = (stats: UncertaintyStats, color: string) => (
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 p-6 rounded-lg space-y-4">
              ...
              <div className="space-y-3 text-blue-800">
                ...
                <p>3. We&lsquo;ll compare how well each question helps find the ships</p>
              </div>
            </div>
            <Button
              onClick={startGame}
              ...
              <Alert className="flex flex-col gap-2">
                <div className="flex items-center gap-2 w-full">
                  ...
                  <AlertDescription className="flex-1">
                    Your question: &ldquo;{userQuestion}&rdquo;
                  </AlertDescription>
                </div>
              ...
              <div className="space-y-4">
                <Alert className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 w-full">
                    ...
                    <AlertDescription className="flex-1">
                      LLM&apos;s question: &ldquo;{llmQuestion}&rdquo;
                    </AlertDescription>
                  </div>
                      ...
                      return (
                        <div
                          ...
                          className={`absolute transform -translate-x-1/2 -translate-y-1/2 ${
                            hoveredCell === ship.row * 6 + ship.col ? 'scale-125' : ''
                          }`}
                          style={{
